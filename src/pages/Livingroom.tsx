...
import image_living from '../components/assets/hero01-free-img.jpg';
...
export default function Livingroom(){
  ...
  return(
    <>
    <header className="header_living"
      style={{
        backgroundImage: `url(${image_living})`,
    ...
    >
      <div className="menu_living">
        <div className="logo">
          <img src={logo} alt="Logo du site" className="logo-image" />
        </div>

        <div className="nav-bar_living">
          <ul>
      ...
      <div className="text-center_living">
        <h1>Living Room</h1>
